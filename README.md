...
- Universal (Intel and Apple Silicon): [`Sensible-Side-Buttons-2.0-universal.zip`](https://github.com/sohampatwardhan/sensible-side-buttons/releases/download/v2.0/Sensible-Side-Buttons-2.0-universal.zip)
